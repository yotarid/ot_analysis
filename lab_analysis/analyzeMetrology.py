...
ax1.set_xlabel("Module Id", fontsize=12)
ax1.set_ylim(0, 1200)
ax1.set_xlim(0, 6)
ax1.set_ylabel(r"R ($\mu rad$)", fontsize=12)
...
ax2 = ax1.twinx()
ax2.set_ylabel(r"Tx, Ty ($\mu m$)", fontsize=12)
ax2.set_ylim(0, 200)
...
plt.legend(handles = [R_plot, Tx_plot, Ty_plot], labels=["R = rotation", r"Tx = translation $\perp$ to strips", r"Ty = translation $\parallel$ to strips"], loc="upper right", fontsize=12)
plt.grid(alpha=0.5)
plt.tight_layout()
# plt.show()
