...
ax1.set_ylim(0, 1000)
ax1.set_xlim(0, 6)
ax1.set_ylabel(r"|R| ($\mathrm{\mu rad}$)", fontsize=16)
...
ax2 = ax1.twinx()
ax2.set_ylabel(r"|Tx|, |Ty| ($\mathrm{\mu m}$)", fontsize=16)
ax2.set_ylim(0, 200)
...
plt.legend(handles = [R_plot, Tx_plot, Ty_plot], labels=["R = rotation", r"Tx = translation $\perp$ to strips", r"Ty = translation $\parallel$ to strips"], loc="upper left", fontsize=16, bbox_to_anchor=(1.15, 1.03))
