...
def main():
  ...
  ax1.hist(chi2_x, weights=chi2_cnt_final, bins=chi2_nbins*10, density=False, histtype='step', color='navy', linewidth=1, fill=False, label='Final Tracking', zorder=3)
  ax1.set_xlim(0,10)
  ...
  ax2.hist(ntracks_x, weights=ntracks_cnt, bins=ntracks_nbins, density=False, histtype='step', color='navy', linewidth=1, fill=False, label='Final Tracking', zorder=3)
