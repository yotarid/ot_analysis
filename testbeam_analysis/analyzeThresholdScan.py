...
def main():
  ...
  fig, ax = plt.subplots()
  plt.tight_layout()
  psp_plot = ax.errorbar(mpa_thresholds, psp_efficiencies, yerr=psp_efficiencies_err, linestyle='solid', linewidth=1, marker='o', markersize=5, color='darkred', label='PS-p')
