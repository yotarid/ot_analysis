...
def main():
  ...
  plt.tight_layout()
  ax1.hist(res_x, weights=psp_cnt_initial, bins=nbins, density=True, histtype='step', color='darkred', linewidth=1, fill=False, label='Initial alignment', zorder=3)
  ax1.hist(res_x, weights=psp_cnt_final, bins=nbins, density=True, histtype='step', color='darkgreen', linewidth=1, fill=False, label='Final alignment', zorder=3)
  ...
  plt.tight_layout()
  ax2.hist(res_x, weights=pss_cnt_initial, bins=nbins, density=True, histtype='step', color='darkred', linewidth=1, fill=False, label='Initial alignment', zorder=3)
  ax2.hist(res_x, weights=pss_cnt_final, bins=nbins, density=True, histtype='step', color='darkgreen', linewidth=1, fill=False, label='Final alignment', zorder=3)
